...
public:
    ...
    {
        return XMLPrint!T.makeXmlProcessingInstruction(id_,data_);
    }
...
public:
    ...
    override  XmlString toXmlString() const
    {
        return XMLPrint!T.makeXmlCDATA(id_);
    }
};
...
public:
    ...
    override  XmlString toXmlString() const
    {
        return XMLPrint!T.makeXmlComment(id_);
    }
};
...
alias XMLPrint!(T).XmlPrinter	PrintDom;
...
void printLinked(Node n, PrintDom tp)
{
    while(n !is null)
    {
        ...
        case NodeType.Document_type_node:
            ...
            break;
        default:
            auto txt = XMLPrint!T.encodeStdEntity(n.toXmlString(), tp.options.charEntities);
            tp.putIndent(txt);
            break;
        }
        n = n.getNextSibling();
...
{
    auto  opt = XMLPrint!T.XmlPrintOptions(putOut);
    ...
    if (!canon || (opt.xversion > 1.0))
    {
        ...
        //
        XMLPrint!T.printXmlDeclaration(attributes, putOut);
    }
