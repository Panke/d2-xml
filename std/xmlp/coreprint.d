...
import alt.arraymap;
    ...
    alias AssociativeArray!(dchar, string)  CharEntityMapTpl; // required for dmd link
    alias string[dchar] CharEntityMap;
}
/* Options to control output */

public void mapToAttributePairs(AttributeMap map, ref AttributePairs ap)
{
	foreach(n,v ; map)
	{
...
struct XmlPrinter
{
    ...
    private Buffer!char	pack; // each indent level with reusable buffer
