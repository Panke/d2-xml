...
import std.stdio, std.conv, std.ascii, std.exception;
import std.xml2, std.xmlp.xpath1, std.xmlp.coreprint, std.xmlp.linkdom;
import alt.zstring;
		...
		while (ch !is null)
		{
			...
			case NodeType.Element_node:
				...
				if (prefix == "xsl")
				{
					...
					auto smap = toAttributeMap(e);
					//string startElem = tp.putStartTag(tag,smap,false);
					if (!hasChildren)
					{
