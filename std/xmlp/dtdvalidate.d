...
class DTDValidate
{
    ...
    void validateAttributes(IXMLParser cp, XmlReturn ret)
    {
    ...
    */
    bool addDefaultAttributes(IXMLParser cp, XmlReturn ret, AttributeList alist)
    {
        string value;
        string* pvalue;
